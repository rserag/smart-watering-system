...
function telegramIssue(value: string) {
  return ({ controller_restart: 'Controller restarted' } as Record<string, string>)[value] ?? value;
}

function supportsManualTelegramDebug(value: string | null) {
...
export default function Dashboard() {
  ...
  const manualTelegramSupported = selected ? supportsManualTelegramDebug(selected.firmwareVersion) : false;
